        ...
        <div class="relative py-3 max-w-xl mx-auto">
            ...
            <div class="relative bg-white shadow-lg dark:shadow-none rounded-3xl p-12 lg:p-20 dark:bg-gray-800 border border-opacity-0 border-gray-300 dark:border-opacity-100">
                <div class="max-w-md mx-auto ">
                    ...
                    <p class="mt-3 text-base text-gray-500 dark:text-gray-300 leading-loose tracking-relaxed text-left whitespace-pre-line">{{$t('contactslogan')}}</p>
                    <hr class="mt-3 border-gray-300">
                    </div>
                    <div class="divide-y divide-gray-200">
                        <form @submit.prevent="sendEmail" class="pt-8 text-base leading-6 space-y-2 text-gray-700 sm:text-lg sm:leading-7 -mb-8">
                            <label class="block font-bold text-sm text-gray-500 dark:text-gray-300 leading-loose tracking-relaxed text-left">
                                Name <span class="text-red-500">*</span>
                            </label>
                            <input required v-model="from_name" class="appearance-none text-base block w-full bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Name">
                            
                            <label class="block font-bold text-sm text-gray-500 dark:text-gray-300 leading-loose tracking-relaxed text-left">
                                Email <span class="text-red-500">*</span>
                            </label>
                            <input v-model="email" required class="appearance-none text-base block w-full bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="email" placeholder="Email">
                            ...
                            <div class="flex items-end justify-end">
                                <button type="submit" class="bg-fakhti hover:bg-turquoise text-white font-semibold py-2 px-4 rounded text-base">
                                    Send
                                </button>
                            </div>
